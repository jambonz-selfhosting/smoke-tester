...
type Account struct {
	...
	// ServiceProviderDisableMediaCapture is derived from the owning SP; read-only.
	ServiceProviderDisableMediaCapture bool `json:"service_provider_disable_media_capture"`
}
